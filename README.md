<p align="center">
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/XTY64XTY12345/Xdows-Security/issues ">Feedback</a>
    ·
...
1. Open the [download page](https://github.com/XTY64XTY12345/Xdows-Security/releases ) to download the latest version of `Xdows-Security.zip`
2. Extract the zip file to the target location and run `Xdows-Security.exe`
